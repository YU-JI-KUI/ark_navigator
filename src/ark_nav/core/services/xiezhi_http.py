...
实现拆分到：
    xiezhi/llm_client.py        — call_bigmodel_api
    xiezhi/kb_client.py         — search_kb, fetch_rag, extract_answer, _get_faq_*_data 等
    xiezhi/prompt_repository.py — init_prompt_from_agent_rag, _get_prompt_by_name
...
from ark_nav.core.services.xiezhi.llm_client import call_bigmodel_api
...
from ark_nav.core.services.xiezhi.prompt_repository import init_prompt_from_agent_rag

# 防御性导出：原 xiezhi_http.py 的全部公开符号
__all__ = [
    "call_bigmodel_api",
    "fetch_rag",
    "init_prompt_from_agent_rag",
    "search_kb",
    "extract_answer",
    "_get_faq_page_data",
    "_get_faq_table_data",
